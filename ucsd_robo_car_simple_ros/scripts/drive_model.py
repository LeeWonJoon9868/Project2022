...
class cmd_vel_node(object):
    ...
    def run(self):
         ...
         f = h5py.File('/home/hy-ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.h5', mode='r')
         ...
         with open('/home/hy-ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.json', 'r') as f:
             model = model_from_json(f.read())

         model = load_model('/home/hy-ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.h5')

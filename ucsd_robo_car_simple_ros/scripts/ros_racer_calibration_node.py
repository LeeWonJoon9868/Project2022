...
class Calibration:
    ...
    def live_calibration_values(self,data):
        ...
        #        "Width_max : {%d} \n"
        #        "inverted_filter : {%d} \n"
        #        "camera_start_height : {%d} \n"
        #        "camera_bottom_height : {%d} \n"
        #        "camera_left_width : {%d} \n"
        #        "camera_right_width : {%d} \n"
        #        "steering_sensitivity : {%d} \n"
        #        "zero_throttle : {%d} \n"
        #        "no_error_throttle : {%d} \n"
        #        "error_throttle : {%d} \n"
        #        %(lowH,highH,lowS,highS,lowV,highV,gray_thresh,number_of_lines,error_threshold,min_width,max_width,inverted_filter,start_height,bottom_height,left_width,right_width,Steering_sensitivity,self.zero_throttle,self.zero_error_throttle,self.error_throttle))
        f.close()

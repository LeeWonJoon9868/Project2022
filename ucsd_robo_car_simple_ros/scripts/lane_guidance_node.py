...
class PathPlanner:
    def __init__(self):
        ...
        self.twist_stamped_publisher = rospy.Publisher('/cmd_vel_stamped', TwistStamped, queue_size=1)
        self.steering_float = Float32()
        self.throttle_float = Float32()
        self.cmd_vel_twist = Twist()
        self.cmd_vel_twist_stamped = TwistStamped()
    ...
    def controller(self, data):
        ...
        self.cmd_vel_twist.linear.x=throttle_float
        self.cmd_vel_twist.angular.z=steering_float


        now = rospy.get_rostime()
        self.cmd_vel_twist_stamped.header.stamp.secs=now.secs
        self.cmd_vel_twist_stamped.header.stamp.nsecs=now.nsecs
        self.cmd_vel_twist_stamped.twist.linear.x=throttle_float
        self.cmd_vel_twist_stamped.twist.angular.z=steering_float
        self.twist_publisher.publish(self.cmd_vel_twist)
        self.twist_stamped_publisher.publish(self.cmd_vel_twist_stamped)

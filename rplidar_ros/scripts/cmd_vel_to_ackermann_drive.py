...
if __name__ == '__main__': 
  try:
    ...
    twist_cmd_topic = rospy.get_param('~twist_cmd_topic', '/mobile_base/commands/velocity') 
    ackermann_cmd_topic = rospy.get_param('~ackermann_cmd_topic', '/ackermann_cmd_mux/input/default')

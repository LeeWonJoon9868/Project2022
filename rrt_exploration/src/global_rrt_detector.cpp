...
int i=0;
float xr,yr;
vec<float> x_rand,x_nearest,x_new,near_inds;
...
char   checking=ObstacleFree(x_nearest,x_new,mapData);
	  ...
	  if (checking==-1){
          	...
          	exploration_goal.point.x=x_new[0]*1.02;
          	exploration_goal.point.y=x_new[1]*1.02;
		 ...
		 // 	points.points.clear();
	        ...
	        x_new = chooseparent(V,x_new,near_inds,mapData); 

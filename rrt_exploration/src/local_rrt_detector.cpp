...
float xr,yr,xr2,yr2;
int checking;
vec<float> a,x_rand,x_nearest,x_new,near_inds,next_node,init_node,temp_node,target_goal,temp_goal,real_goal,x_rand2;
real_goal.clear();
real_goal.push_back(-2.57); real_goal.push_back(2.66);

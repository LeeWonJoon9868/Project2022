...
class cmd_vel_node(object):
    def __init__(self):
      ...
      """ Variables """
      self.model_path = '/home/hanjokim/catkin_ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.h5'
      self.cmdvel = Twist()
    ...
    def run(self):
         ...
         f = h5py.File('/home/hanjokim/catkin_ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.h5', mode='r')
         ...
         with open('/home/hanjokim/catkin_ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.json', 'r') as f:
             model = model_from_json(f.read())

         model = load_model('/home/hanjokim/catkin_ws/src/diy_driverless_car_ROS/rover_ml/behavior_cloning/src/behavior_cloning/model.h5')
